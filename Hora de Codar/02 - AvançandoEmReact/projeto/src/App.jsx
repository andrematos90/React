...
import ComidaDetails from "./components/ComidaDetails";
...
function App() {
  ...
  const comidas = [
    { id: 1, nome: "pizza", sabor: "alho e óleo", calorias: 600, engordaMuito: true},
    { id: 2, nome: "sorvete", sabor: "creme", calorias: 800, engordaMuito: true },
    { id: 3, nome: "torta", sabor: "limão", calorias: 400, engordaMuito: false },
  ];
  ...
  return (
    <div>
      ...
      <div>
        ...
        {comidas.map((comida) => (
          <ComidaDetails
            nomeDaComida={comida.nome}
            sabor={comida.sabor}
            calorias={comida.calorias}
            engorda={comida.engordaMuito}
          ></ComidaDetails>
        ))}
      </div>
    </div>
