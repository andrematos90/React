...
const url = "http://localhost:500/products"; // Define a URL da API para onde a requisição será feita
...
function App() {
  ...
  const { data: items, loading, error } = useFetch(url); // esta enviando a url e recebendo data que vira items, e recebendo loading e
  ...
  return (
    <div className="App">
      ...
      <div>
        {loading && <p>Carregando....</p>} {/* Exibe mensagem de carregamento enquanto a requisição está em andamento */}

        {error && <p style={{ color: "red" }}>Erro: {error}</p>} {/* Exibe mensagem de erro se ocorrer algum problema */}
